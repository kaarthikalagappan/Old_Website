...
if ($name != "") {
	$loginDetail = "Logout";
	$loginURL = "checkLogout.php?redirected=about";
	$name = "Welcome " . $name . "!";
}
else {
	$loginDetail = "Login";
...
<head>
  <title>About.</title>
  <meta charset="UTF-8">  
  <meta name="description" content="Stamp World. Here you can find information that led to creation of this website.">
...
#background_one .small_head:hover {
	animation-name: borderColor;
    animation-duration: 15s;
	animation-iteration-count: infinite;
}
@keyframes borderColor {
	0% {border: 2px solid #FF7481;}
	25% {border: 2px solid #FFFB74;}
	50% {border: 2px solid #74FF9B;}
	75% {border: 2px solid #7494FF;}
	100% {border: 2px solid #FF7481;}
}
</style>
...
<!--close small header-->
      ...
      <div id="background_one">
        ...
        Stamp World. was founded in 2015 and has provided information about different sets of stamps, stamps that are rare and unique, stamps that are considered to be few of the best, stamps that were born during the age of long-distance communication.
		We, the people at Stamp World., do our best to provide a wide variety of [almost-] precise information about stamps that a stamp collector will find amusing. The main focus behind this website is to serve a one-stop website for stamp collectors where they could get information about a specific stamp or get an idea about what kind of stamps they might be looking for. <br></span><br>
		
		<span style="font-size: 0.96em; text-decoration: italic;">Got a suggest that we could add to our website? Or found any information that is incorrect? Please feel free to contact us at <a href="mailto:5917000760@student.myscps.us">5917000760@student.myscps.us</a></span>
      </div>      <!--bg 1-->
</div><!--containerMain-->
    <footer>
      <div id="footerText">
